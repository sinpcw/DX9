...
//
//***********************************************************************************************************************************************************************
//		owl::engine::PRIMITIVE3D9X::PRIMITIVE3D9X()
//***********************************************************************************************************************************************************************
owl::engine::PRIMITIVE3D9X::PRIMITIVE3D9X(){
	uSize	= 0;
	uPush	= 0;
...
//***********************************************************************************************************************************************************************
void owl::engine::render::SPOT3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9X &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_POINTLIST, (Primitive.Push()), Primitive.Base(), sizeof(owl::engine::XDVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::LINE3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::LINE3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9X &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_LINELIST, (Primitive.Push() >> 1), Primitive.Base(), sizeof(owl::engine::XDVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::WIRE3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::WIRE3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9X &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_LINESTRIP, Primitive.Push() - 1, Primitive.Base(), sizeof(owl::engine::XDVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::POLY3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::POLY3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9X &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_TRIANGLELIST, (Primitive.Push() / 3), Primitive.Base(), sizeof(owl::engine::XDVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::QUAD3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::QUAD3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9X &Primitive){
	XDVERTEX3D *	pVtx;
	...
	if(SUCCEEDED(Primitive.VtxBuf()->Lock(0, 0, reinterpret_cast<void **>(&pVtx), 0))){
		...
		if(SUCCEEDED(Primitive.VtxBuf()->Unlock())){
			...
			pDevice->SetFVF(FVF_XDVERTEX3D);
			pDevice->SetStreamSource(0, Primitive.VtxBuf(), 0, sizeof(XDVERTEX3D));
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::InitPrimitive(PRIMITIVE3D9X &_Prm, unsigned int _Buffer, unsigned int _Primitive){
	if(_Prm.pInfo != NULL){
		return (true);
	}
	switch(_Primitive){
		case (owl::engine::PRIMITIVE_POINT):
			try{
				_Prm.pInfo	= new XDVERTEX3D[_Buffer];
			}catch(std::bad_alloc){
				QuitPrimitive(_Prm);
				return (false);
			}
			...
			memset(_Prm.pInfo, 0, sizeof(XDVERTEX3D));
			break;
		...
		case (owl::engine::PRIMITIVE_QUAD):
			...
			if(FAILED(pDevice->CreateVertexBuffer(_Buffer * sizeof(XDVERTEX3D), 0, FVF_XDVERTEX3D, D3DPOOL_MANAGED, &_Prm.pVB, NULL))){
				QuitPrimitive(_Prm);
				return (false);
			}
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::QuitPrimitive(PRIMITIVE3D9X &_Prm){
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::PostPrimitive(PRIMITIVE3D9X &_Prm, const core::VECT3f &_Point, const core::COLORf &_Color){
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::DrawPrimitive(PRIMITIVE3D9X &_Prm){
	pDevice->SetFVF(FVF_XDVERTEX3D);
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::BindPrimitive(PRIMITIVE3D9X &_Prm, unsigned int _Primitive){
