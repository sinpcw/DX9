...
//
//***********************************************************************************************************************************************************************
//		owl::engine::PRIMITIVE3D9N::PRIMITIVE3D9N()
//***********************************************************************************************************************************************************************
owl::engine::PRIMITIVE3D9N::PRIMITIVE3D9N(){
	uSize	= 0;
	uPush	= 0;
...
//***********************************************************************************************************************************************************************
void owl::engine::render::SPOT3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9N &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_POINTLIST, (Primitive.Push()), Primitive.Base(), sizeof(owl::engine::DNVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::LINE3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::LINE3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9N &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_LINELIST, (Primitive.Push() >> 1), Primitive.Base(), sizeof(owl::engine::DNVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::WIRE3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::WIRE3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9N &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_LINESTRIP, Primitive.Push() - 1, Primitive.Base(), sizeof(owl::engine::DNVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::POLY3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::POLY3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9N &Primitive){
	pDevice->DrawPrimitiveUP(D3DPT_TRIANGLELIST, (Primitive.Push() / 3), Primitive.Base(), sizeof(owl::engine::DNVERTEX3D));
}

//***********************************************************************************************************************************************************************
//		owl::engine::render::QUAD3D(IDirect3DDevice9 *, PRIMITIVE3D &)
//***********************************************************************************************************************************************************************
void owl::engine::render::QUAD3D(IDirect3DDevice9 *pDevice, owl::engine::PRIMITIVE3D9N &Primitive){
	DNVERTEX3D *	pVtx;
	...
	if(SUCCEEDED(Primitive.VtxBuf()->Lock(0, 0, reinterpret_cast<void **>(&pVtx), 0))){
		...
		if(SUCCEEDED(Primitive.VtxBuf()->Unlock())){
			...
			pDevice->SetStreamSource(0, Primitive.VtxBuf(), 0, sizeof(DNVERTEX3D));
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::InitPrimitive(PRIMITIVE3D9N &_Prm, unsigned int _Buffer, unsigned int _Primitive){
	if(_Prm.pInfo != NULL){
		return (true);
	}
	switch(_Primitive){
		case (owl::engine::PRIMITIVE_POINT):
			try{
				_Prm.pInfo	= new DNVERTEX3D[_Buffer];
			}catch(std::bad_alloc){
				QuitPrimitive(_Prm);
				return (false);
			}
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::QuitPrimitive(PRIMITIVE3D9N &_Prm){
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::PostPrimitive(PRIMITIVE3D9N &_Prm, const core::VECT3f &_Point, const core::VECT3f &_Normal, const core::COLORf &_Color){
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::DrawPrimitive(PRIMITIVE3D9N &_Prm){
	pDevice->SetFVF(FVF_DNVERTEX3D);
...
//***********************************************************************************************************************************************************************
bool owl::engine::GRAPH9::BindPrimitive(PRIMITIVE3D9N &_Prm, unsigned int _Primitive){
